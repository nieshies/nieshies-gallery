...
const ACHIEVEMENT_COLORS = {
  "first-click": "rgba(244,140,54,0.3)",
  "scroll-seeker": "rgba(255,179,71,0.3)",
  "scroll-adept": "rgba(255,179,71,0.4)",
  "gallery-initiate": "rgba(244,140,54,0.3)",
  "gallery-aficionado": "rgba(244,140,54,0.4)",
  "quote-taster": "rgba(244,140,54,0.3)",
  "logo-devotee": "rgba(244,140,54,0.3)",
  "vibe-seeker": "rgba(244,140,54,0.3)",
  "rising-star": "rgba(244,140,54,0.5)",
  "dedicated": "rgba(255,179,71,0.5)",
};
      ...
      {def && (
        <motion.div
          ...
          style={{
            ...
            borderColor: ACHIEVEMENT_COLORS[def.id] || "rgba(244,140,54,0.2)",
          }}
        >
          <div
            className="absolute inset-0 opacity-10"
            style={{
              background: `linear-gradient(135deg, ${ACHIEVEMENT_COLORS[def.id] || "rgba(244,140,54,0.3)"}, transparent)`,
            }}
          />
          <div className="relative px-4 py-3 flex items-start gap-3">
            <div
              ...
              style={{
                backgroundColor: ACHIEVEMENT_COLORS[def.id] || "rgba(244,140,54,0.15)",
              }}
            >
              <motion.span
            ...
            <div className="min-w-0">
              <p className="text-xs font-display uppercase tracking-widest" style={{ color: "rgba(244,140,54,0.7)" }}>
